CREATE OR REPLACE PROCEDURE copy_piece_of_data(IN from_ordering BIGINT, IN to_ordering BIGINT,
                                               IN source_tag_separator TEXT, IN source_schema TEXT,
                                               IN source_journal_table_name TEXT, IN destination_schema TEXT,
                                               IN destination_journal_table_name TEXT, IN destination_tag_table TEXT) AS
$$
BEGIN
    EXECUTE '
...
CREATE OR REPLACE PROCEDURE copy_data(IN from_ordering BIGINT, IN batch_size BIGINT, IN source_tag_separator TEXT,
                                      IN source_schema TEXT, IN source_journal_table_name TEXT,
                                      IN destination_schema TEXT, IN destination_journal_table_name TEXT,
                                      IN destination_tag_table TEXT) AS
$$
DECLARE
    batch_number BIGINT;
    max_ordering BIGINT;
