...
psql -q ${CONNECTION_OPTIONS} --command="CALL create_partitions(${PARTITION_SIZE}, '${SOURCE_SCHEMA}', '${SOURCE_JOURNAL_TABLE_NAME}', '${DESTINATION_SCHEMA}', '${DESTINATION_JOURNAL_TABLE_NAME}', '${DESTINATION_JOURNAL_PARTITION_PREFIX}');"
showStructure
...
#psql -qt ${CONNECTION_OPTIONS} --command="INSERT INTO public.journal_partitioned(persistence_id, sequence_number, deleted, tags, message) VALUES ('pp-1', 1000001, true, '{}', '0x22');"
