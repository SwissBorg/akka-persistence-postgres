...
import akka.persistence.postgres.config.{ ConfigKeys, SlickConfiguration }
 ...
 * - The fully qualified class name as configured in `pg-journal.database-provider-fqcn`.
