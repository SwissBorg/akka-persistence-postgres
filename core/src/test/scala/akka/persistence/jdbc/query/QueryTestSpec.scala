...
import akka.persistence.jdbc.util.Schema.{PostgresPartitioned, SchemaType}
...
trait PostgresPartitionedCleaner extends QueryTestSpec {

  def schemaType: SchemaType = PostgresPartitioned()
