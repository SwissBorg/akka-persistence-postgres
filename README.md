...
```scala
libraryDependencies += "com.swissborg" %% "akka-persistence-postgres" % "0.5.0-M9"
```
...
```
libraryDependencies += "com.swissborg" %% "akka-persistence-postgres-migration" % "0.5.0-M9"
``` 
For a maven project add: 
```xml
<dependency>
